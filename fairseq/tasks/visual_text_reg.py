...
from fairseq.data.visual import VisualTextRegDataset, TextRegImageGenerator
...
import fairseq.data.visual.reg_image_generator as imgen
...
@register_task("visual_text_reg")
class VisualTextRegTask(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, tgt_dict):
        ...
        self.image_generator = VisualTextRegTask.build_image_generator(args)
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = VisualTextRegDataset.load(
            self.args.data,
            self.args,
            split,
            self.source_lang,
    ...
    def build_image_generator(args):
        ...
        if args.image_font_path is not None:
            image_generator = TextRegImageGenerator(window=args.image_window,
    ...
    def build_model(self, args):
        ...
        return super(VisualTextRegTask, self).build_model(args)
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, **kwargs):
        ...
        """
        dataset = VisualTextRegDataset.from_text(
            self.args,
            src_tokens,
            self.image_generator,
            self.tgt_dict,
