...
@register_task("pixel_translation_multi_simple_epoch")
class PixelTranslationMultiSimpleEpochTask(LegacyFairseqTask):
    """
    ...
    def __init__(self, args, langs, dicts, training):
        ...
        self.image_generator = PixelTranslationMultiSimpleEpochTask.build_image_generator(args)
        self.sampling_method = SamplingMethod.build_sampler(args, self)
        self.data_manager = MultilingualDatasetManager.setup_data_manager(
            args, self.lang_pairs, langs, dicts, self.sampling_method, self.image_generator
        )
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, constraints=None):
        ...
        --> lang tokens currently not supported, simplest working implementation.
        """
        dataset = VisualTextDataset.from_text(
            self.args,
            src_tokens,
            self.image_generator,
            self.dicts[self.target_langs[0]],
            constraints,
            )
    ...
    def build_model(self, args):
        ...
        self.image_generator = PixelTranslationMultiSimpleEpochTask.build_image_generator(args)
        return super(PixelTranslationMultiSimpleEpochTask, self).build_model(args)
