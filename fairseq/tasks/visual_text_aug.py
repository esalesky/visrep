...
from fairseq.data.visual import VisualTextAugDataset, TextImageGenerator
...
@register_task("visual_text_aug")
class VisualTextAugTask(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, tgt_dict):
        ...
        self.image_generator = VisualTextAugTask.build_image_generator(args)
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = VisualTextAugDataset.load(
            self.args.data,
            self.args,
            split,
            self.source_lang,
    ...
    def build_model(self, args):
        ...
        return super(VisualTextAugTask, self).build_model(args)
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, **kwargs):
        ...
        """
        dataset = VisualTextAugDataset.from_text(
            self.args,
            src_tokens,
            self.image_generator,
            self.tgt_dict,
