...
def vista_fractional(pretrained=False, progress=True, **kwargs):
    model = VistaOCR(maxpool=False)
    return model


def vista_maxpool(pretrained=False, progress=True, **kwargs):
    model = VistaOCR(maxpool=True)
    return model
