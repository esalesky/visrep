...
#dev
python /exp/esalesky/mtocr19/fairseq/generate.py /exp/esalesky/mtocr19/$PAIR/data/$SEGM --path $CKPT_DIR/checkpoint_best.pt --batch-size 128 --beam 5 --remove-bpe=sentencepiece --dataset-impl raw --sacrebleu --quiet --gen-subset valid
echo "dev scored"
#test
python /exp/esalesky/mtocr19/fairseq/generate.py /exp/esalesky/mtocr19/$PAIR/data/$SEGM --path $CKPT_DIR/checkpoint_best.pt --batch-size 128 --beam 5 --remove-bpe=sentencepiece --dataset-impl raw --sacrebleu --quiet --gen-subset test
echo "test scored"
