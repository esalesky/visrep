...
CKPT_DIR=/expscratch/detter/mt/multitarget-ted/visemb/$SRC_LANG-$TGT_LANG/${SIZE}/vis_trans/prefreeze
FONT_FILE=/expscratch/detter/fonts/mt/test_${SRC_LANG}_font.txt
EMBED_FILE=/expscratch/detter/mt/multitarget-ted/visemb/$SRC_LANG-$TGT_LANG/${SIZE}/norm_word_embeddings.txt
...
--image-disable \
--image-embed-path=$EMBED_FILE \
--image-freeze-encoder-embed \
