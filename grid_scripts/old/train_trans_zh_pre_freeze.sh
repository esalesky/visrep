...
# /expscratch/detter/src/fairseq/fairseq-ocr/grid_scripts/train_trans_zh_pre_freeze.sh
#
#
...
CKPT_DIR=/expscratch/detter/mt/multitarget-ted/en-zh/matt/spm.20000.10k/raw/exp/trans_pre_freeze
