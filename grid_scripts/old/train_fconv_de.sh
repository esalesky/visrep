...
# 2019-10-16
#
# qsub -v PATH -S /bin/bash -b y -q gpu.q@@1080 -cwd -j y -N defconv2 \
#   -l num_proc=16,mem_free=32G,h_rt=48:00:00,gpu=1 \
#   /expscratch/detter/src/fairseq/fairseq_scripts/10000/train_fconv_de.sh
#
#
...
CKPT_DIR=/expscratch/detter/mt/multitarget-ted/$TGT_LANG-$SRC_LANG/10000/exp/fairseq/fconv
